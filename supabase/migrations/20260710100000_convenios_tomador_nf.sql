-- Convênios: dados do tomador para NFS-e Nacional (Focus)
-- Fonte: docs/docs2 (jul/2026)
...
COMMENT ON COLUMN public.convenios.codigo_municipio_ibge IS 'IBGE do município do tomador (NFS-e Nacional)';
