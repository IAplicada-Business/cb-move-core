...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      pacientes: {
        Row: {
          ...
          frequencia_atendimento: string | null;
          id: string;
          modelo_relatorio_preferido: Database["public"]["Enums"]["modelo_relatorio"] | null;
    ...
    Enums: {
      ...
      nf_status:
        "pendente" | "emitida" | "cancelada" | "erro" | "regularizada_retroativa" | "processando";
      paciente_tipo: "particular" | "judicial" | "convenio" | "puc";
      periodizacao_status: "planejada" | "em_andamento" | "concluida" | "cancelada";
