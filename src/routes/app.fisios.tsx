...
function invalidateFisioListQueries(qc: ReturnType<typeof useQueryClient>) {
...
function FisiosPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      if (editing?.id) invalidateFisioDetailQueries(qc, editing.id);
  ...
  return (
    <DashboardPage>
      <PageHeader
        ...
        description="Equipe clínica — clique no nome para ver detalhes e atividades"
        actions={
